        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
              ...
              <p class="lead mb-4">Las mejores frutas seleccionadas directamente del 
                campo a tu mesa. Frescas y calidad garantizada. Diego Lipa
              </p>
            ...
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-body d-flex flex-column">
                  ...
                  <div class="d-flex justify-content-between align-items-center mt-3 px-2">
                    <span class="fw-bold text-success fs-4">${ producto.precio } PEN</span>
...
export function mostarModalDetalles(){
  return `
    <!-- Modal -->
